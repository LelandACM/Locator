...
public:
     ...
     */
    ClientSensorLaserDatagram getWaitConstantScan(float ranges[])
    {
        ...
        result.angleInc = M_PI / 180 * 270 / (nBeams-1) ;
        result.angleEnd = result.angleStart + result.angleInc*(nBeams-1);
