...
enum PAVO_REG_INDEX {
	...
	REG_ECHO_MODE_GET, //31
	REG_ECHO_MODE_SET,

	REG_ANTI_MODE_GET, //33
	REG_ANTI_MODE_SET,
	REG_ANTI_WINDOW_GET,
	REG_ANTI_WINDOW_SET
};
...
static const unsigned char PAVO_REG[][PAVO_REG_LEN]  = {
	...
	{0xEB, 0x90, 0xB0, 0x78},  //REG_DEVICE_PN_GET,  //26
	{0xEB, 0x90, 0xB0, 0x79},   //REG_DEVICE_SN_GET

	{0xEB, 0x90, 0xC0, 0x00 },   //REG_DATA_TRANSFER_DATA_MODE

	{ 0xEB, 0x90, 0xB0, 0x7F },  //REG_FW_VER_GET,  //29
	{ 0xEB, 0x90, 0xB0, 0xD1 },   //REG_ERROR_CODE_GET

	{ 0xEB, 0x90, 0xB0, 0x2D },  //REG_ECHO_MODE_GET,
	{ 0xEB, 0x90, 0xA0, 0x2D },  //REG_ECHO_MODE_SET
	
	{ 0xEB, 0x90, 0xB0, 0x14 },  //REG_ANTI_MODE_GET,
	{ 0xEB, 0x90, 0xA0, 0x14 },  //REG_ANTI_MODE_SET
	{ 0xEB, 0x90, 0xB0, 0x82 },   //REG_ANTI_MODE_WINDOW
	{ 0xEB, 0x90, 0xA0, 0x82 }   //REG_ANTI_MODE_WINDOW
};
