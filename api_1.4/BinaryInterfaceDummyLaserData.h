...
public:
    ...
    struct __attribute__((packed)) ClientSensorLaserDatagram
    {
        ...
        float maxRange{20.};                              //Constant: no ranges bigger than 60
     ...
     */
    ClientSensorLaserDatagram getWaitConstantScan(float ranges[], bool hasIntensity, float intensity[])
    {
